...
import { ELEMENT_NAME_OFFSET, SELECTED_ELEMENT_PADDING } from "../pages/editor/workspace/workspace-drawer.constants";
...
export function getBoundingRect(element: IElement): IPosition & ISize {
  return {
    ...
    height: element.size.height + (SELECTED_ELEMENT_PADDING * 2) + ELEMENT_NAME_OFFSET * 2
  }
}
